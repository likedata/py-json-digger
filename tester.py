...
print r_k #  {u':sys:country': [u'GB']}
print r_v #  {u':main:temp': [278.05], u':main:temp_max': [278.05], u':main:temp_min': [278.05]}

#  alternative call - directly the function inside class
print JsonDigger.f_dig_for_keys(retrieved_json_net, 'country') #  {u':sys:country': [u'GB']}
print JsonDigger.f_dig_for_values(retrieved_json_net, 278.05) #  {u':main:temp': [278.05], u':main:temp_max': [278.05], u':main:temp_min': [278.05]}